    ...
    <div class="card-body" style="padding:0;">
        ...
        <div style="display:flex;gap:14px;padding:16px 20px;border-bottom:1px solid var(--border);align-items:flex-start;">
            ...
            <div style="flex-shrink:0;text-align:right;display:flex;flex-direction:column;align-items:flex-end;gap:8px;">
                ...
                <form method="POST" action="{{ route('member.kembalikan.request',$p->id_pinjam) }}">
                    @csrf @method('PATCH')
                    <button type="submit" class="btn btn-sm btn-warning" onclick="return confirm('Request pengembalian buku ini?')">
                        <i class="fas fa-paper-plane"></i> Request Pengembalian
                    </button>
                </form>
