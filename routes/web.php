...
Route::middleware(['auth','admin'])->group(function () {
    ...
    Route::prefix('peminjaman')->name('peminjaman.')->group(function () {
        ...
        Route::patch('/{peminjaman}/konfirmasi-kembalikan', [PeminjamanController::class, 'konfirmasiKembalikan'])->name('konfirmasiKembalikan');
...
Route::middleware(['auth','member'])->prefix('member')->name('member.')->group(function () {
    ...
    Route::patch('/kembalikan-request/{peminjaman}', [MemberController::class, 'requestKembalikan'])->name('kembalikan.request');
